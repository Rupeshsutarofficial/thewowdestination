  ...
  new LazyLoad({ elements_selector: ".lazy" }),
    ...
    t(".categories_carousel").owlCarousel({
      ...
      responsive: {
        ...
        480: { nav: !1, dots: !0, items: 2 },
        768: { nav: !1, dots: !0, items: 3 },
        1025: { nav: !1, dots: !0, items: 4 },
    ...
    t(".carousel_4").owlCarousel({
      ...
      responsive: {
        ...
        560: { items: 2, nav: !1, dots: !0 },
        768: { items: 2, nav: !1, dots: !0 },
        991: { items: 3, nav: !0, dots: !1 },
        1230: { items: 4, nav: !0, dots: !1 },
      },
    }),
    t(window).on("scroll", function () {
      1 < t(this).scrollTop()
        ? t(".element_to_stick").addClass("sticky")
        : t(".element_to_stick").removeClass("sticky");
    }),
    t(window).scroll(),
    ...
    t(window).scroll(function () {
      800 <= t(window).scrollTop()
        ? t("#toTop").addClass("visible")
        : t("#toTop").removeClass("visible");
    }),
  ...
  t(window)
    .resize(function () {
      t(window).width() <= 768
        ...
        : o.removeAttr("data-bs-toggle", "collapse");
    })
    .resize(),
    o.on("click", function () {
    ...
    t('a[href^="#"].btn_scroll').on("click", function (o) {
      ...
      t("html, body")
        .stop()
        .animate({ scrollTop: o.offset().top }, 800, "swing", function () {
          window.location.hash = s;
        });
    }),
    t(".btn_hero.wishlist").on("click", function (o) {
      o.preventDefault(), t(this).toggleClass("liked");
    }),
